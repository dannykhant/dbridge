...
public class RuleT1C extends Rule {
    public RuleT1C() { super(pattern(), new OutputTree(OpType.Seq, new OutputTree(OpType.CartesianProd, new OutputTree(7, node -> new ClassRefNode(((FieldRefNode) node).getTypeClass()))), new OutputTree(9))); }
